...
<body background="weather.jpg">
    <div class="wrapper" style="width: 425px;height: 300px;padding-top: 10px;margin: 10% auto;">
    <div><h2 style="padding-left: 90px">weather Service</h2></div>
    <div class="container">
        <form action="control.php" method="post">
        <div class="form-group col-md-4">
            <label class="" >latitude: </label>
            <input required class="form-control" type="text" name="lat"><br>
            <label class="" >longitude: </label>
            <input required class="form-control" type="text" name="lon"><br>
